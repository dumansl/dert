...
class Typography {
  ...
  Typography({required this.baseStyle})
      : t24w600darkpurple = baseStyle.copyWith(
        ...
        t14w700white = baseStyle.copyWith(
          fontSize: 14,
          fontWeight: FontWeight.w700,
          color: Colors.white,
        ),
        ...
        t14w500white = baseStyle.copyWith(
          fontSize: 14,
          fontWeight: FontWeight.w500,
          color: Colors.white,
        ),
        ...
        t12w700darkpurple = baseStyle.copyWith(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: DertColor.text.darkpurple,
        ),
